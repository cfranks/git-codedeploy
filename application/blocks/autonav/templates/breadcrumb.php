...
//*** Step 2 of 2: Output menu HTML ***/
         //   echo ' <li>'; //opens a nav item
           // echo '<a href="/" target="' . $ni->target . '">Home</a>';
            //echo '</li>';   
if (count($navItems) > 0) {
   // echo '<ul class="nav">'; //opens the top-level menu
    ...
    foreach ($navItems as $ni) {
          if(++$i === count($navItems)) {
            echo '<li class="nav-selected selected-breadcum">'; //opens a nav item
            echo $ni->name;
            echo '</li>';//opens a nav item
...
//
//        if ($ni->hasSubmenu) {
//            echo '<li>'; //opens a dropdown sub-menu
//        } else {
//            echo ' </li>'; //closes a nav item
//            echo str_repeat('</li></li>', $ni->subDepth); //closes dropdown sub-menu(s) and their top-level nav item(s)
//        }
    }
