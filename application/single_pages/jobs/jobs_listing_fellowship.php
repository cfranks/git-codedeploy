 ...
 * For : Single page for listing jobs for fellowship from backend API
 * 
 */
?>
            ...
            if (is_array($json_jobs_list)) {
                if (count($json_jobs_list) > 0) {
                    ...
                    foreach ($json_jobs_list as $jobs) {
                        ...
                        echo "<a style=\"text-decoration:none;\" class=\"button\" href=\"jobs_detail?type=2&jobsid=" . $jobs["JobDetailID"] . "\">View Position</a></p>";
                        echo "<hr>";
                    }
                } else {
