...
function getContent(){
	var text = $('#blog-post-form .redactor_box textarea').val();
	if(!text){
		text = $('#blog-form .redactor_box textarea').val();
	}
	if(!text){
		text = $('#ccm-panel-detail-page-composer .redactor_box textarea').val();
	}
	return text;
}
