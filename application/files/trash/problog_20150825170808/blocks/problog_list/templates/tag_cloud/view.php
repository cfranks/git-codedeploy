...
<?php  
    for ($i = 0; $i < $ttags->count(); $i++) {
        ...
        ?>
        <li><a style="font-size: <?php   echo $tagSizes[$akct->getSelectAttributeOptionUsageCount()]?>px !important" href="<?php  echo $search.rawurlencode(str_replace(' ','_',$akct->getSelectAttributeOptionValue())).'/'?>"><?php   echo $akct->getSelectAttributeOptionValue()?></a>
