...
use \Concrete\Core\Attribute\Key\CollectionKey as CollectionAttributeKey;
    ...
    for ($i = 0; $i < $ttags->count(); $i++) {
        ...
        echo '<a href="'.$search.rawurlencode(str_replace(' ','_',$akct->getSelectAttributeOptionValue())).'/">'.$akct->getSelectAttributeOptionValue().' ('.$akct->getSelectAttributeOptionUsageCount().')</a><br/>';
