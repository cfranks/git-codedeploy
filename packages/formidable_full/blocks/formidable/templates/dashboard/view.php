...
<style> 
    ...
    .formidable .formidable_row { clear:both; overflow: hidden; }
                                                            ...
                                                            <div class="help-block">
                                                                <div id="<?php echo $element->getHandle() ?>_counter" class="counter" type="<?php echo $element->getPropertyValue('min_max_type') ?>" min="<?php echo $element->getPropertyValue('min_value') ?>" max="<?php echo $element->getPropertyValue('max_value') ?>">
                                                                    <?php if ($element->getPropertyValue('max_value') > 0) { ?>
                                                                        <?php  echo t('You have') ?> <span id="<?php echo $element->getHandle() ?>_count"><?php echo $element->getPropertyValue('max_value') ?></span> <?php  echo ($element->getPropertyValue('min_max_type')!='value')?$element->getPropertyValue('min_max_type'):t('characters'); ?> <?php echo t('left')?>.
                                                                    <?php } ?>
                                                                </div>
                                                            </div>
                                                        <?php } ?>
        ...
        $(function() {
            ...
            var ff_<?php echo $f->getFormID(); ?> = formObj<?php echo $f->getFormID(); ?>.formidable({
                ...
                'successCallback': function() { 
                    formidable_results_list.reloadResults()
                }
            });
