...
var ccmFormidableFormElementAddOptions = function(s, value, name) {
	...
	//if (second_text) {
		option += '<input type="text" name="options_name['+option_counter+']" value="'+name+'" style="width: 44%; margin-right: 1%;" placeholder="'+placeholder_option+'" class="form-control ccm-input-text">';
		option += '<input type="text" name="options_value['+option_counter+']" value="'+value+'" style="width: 55%;" placeholder="'+placeholder_value+'" class="form-control ccm-input-text">';
	//} else {
