		...
		<form method="post" action="<?php  echo $controller->action('submit')?>" data-dialog-form="search-customize">
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<select <?php  if (is_array($fldc->getSortableColumns()) && count($fldc->getSortableColumns()) == 0) { ?>disabled="true"<?php  } ?> class="form-control" data-search-select-default-column="<?php  echo $type?>" id="fSearchDefaultSort" name="fSearchDefaultSort">
				...
				<div class="form-group">
					...
					<select <?php  if (is_array($fldc->getSortableColumns()) && count($fldc->getSortableColumns()) == 0) { ?>disabled="true"<?php  } ?> class="form-control" id="fSearchDefaultSortDirection" name="fSearchDefaultSortDirection">
