			...
			<?php 
				...
				?>
					<tr data-launch-search-menu="<?php echo $form->getFormID() ?>">
					    <td class="form_label"><?php echo $form->getLabel(); ?></td>
					...
					<div class="ccm-popover-menu popover fade" data-search-menu="<?php echo $form->getFormID() ?>">
					    ...
					    <div class="popover-inner">
					        <ul class="dropdown-menu">
					            ...
					            <li><a href="<?php echo $preview_url; ?>?formID=<?php echo $form->getFormID(); ?>&amp;ccm_token=<?php echo $token; ?>" class="dialog-launch" dialog-title="<?php echo t('Preview Form'); ?>" dialog-width="900" dialog-height="600" dialog-modal="true"><?php echo t('Preview') ?></a></li>
					            <li class="divider"></li>
					            <li><a href="<?php echo $edit_url; ?>"><?php echo t('Form Properties') ?></a></li>
					            <li><a href="<?php echo $elements_url; ?>"><?php echo t('Layout and elements') ?></a></li>
