...
<div class="ccm-pane-body">
    ...
    <form action="<?php echo $this->action('save_translation'); ?>" method="post">
        <table class="footable table table-striped" style="table-layout: fixed;" data-filtering="true" data-paging="true" data-paging-size="100">
            <thead>
            <tr>
                <th>Default</th>
                <th></th>
            ...
            <?php foreach($langkeys as $key => $value) { 
                ...
                <tr>
                    ...
                    <td data-filter-value="<?php echo Config::get('mass_enrollment::card.'.$language . '.'. $key); ?>">
                        <?php echo $form->textarea($language . '.'. $key, Config::get('mass_enrollment::card.'.$language . '.'. $key), ['placeholder' => 'Type your translation here...']); ?>
                    </td>
                </tr>
            <?php } ?>
        </table>
